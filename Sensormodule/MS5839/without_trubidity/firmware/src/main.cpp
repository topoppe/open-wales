...
void setup()
{
  ...
  sensor.init();      //Init the MS5839-Sensor
  prom_0 = sensor.prom(0);  //Read thee Sensor-Prom into Variables
  prom_1 = sensor.prom(1);
  prom_2 = sensor.prom(2);
  prom_3 = sensor.prom(3);
  prom_4 = sensor.prom(4);
  prom_5 = sensor.prom(5);
  prom_6 = sensor.prom(6);
}
...
void loop()
{
  ...
  TEMPERATURE_RAW = sensor.raw_temp();
  PRESSURE_RAW = sensor.raw_press();
  ...
  output_counter = output_counter + 2;
  hex_print_32(TEMPERATURE);

  output[output_counter] = '1';
  output[output_counter + 1] = '3';
  output_counter = output_counter + 2;
  hex_print_32(PRESSURE); 

  output[output_counter] = '9';
  output[output_counter + 1] = '9';
  output_counter = output_counter + 2;
  hex_print_16(prom_0);
  hex_print_16(prom_1); 
  hex_print_16(prom_2); 
